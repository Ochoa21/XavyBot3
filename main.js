...
const gcrevoke = ["573146224366-1621430788@g.us"]
prefix = '!'
shp = '⬡'
owner = "573146224366@s.whatsapp.net"
spc1 = '         '
spc2 = '\n                           '
spc3 = '                   '
spc4 = '               '
...
console.log(color(figlet.textSync('XavyBot', {
font: 'Standard',
...
console.log(color(`[ • CREADOR OCHOA • ]` ,'cyan'))
console.log(color(`< ================================================== >`, 'cyan'))
console.log(color(`[•]`, 'aqua'), color(`Hola        : ${ucapanWaktu}`, 'white'))
console.log(color(`[•]`, 'aqua'), color(`Bot Version : 1.0.0`, 'white'))
...
whitespaceBreak: false
  ...
  client.on("qr", () => {
    console.log(
      ...
      client.sendMessage(`5731462243669@s.whatsapp.net`, `「 *NOTIFICATION!* 」\n\n _XavyBot Conectado con exito_`, MessageType.extendedText)
...
fkontakk = { key: {
 ...
 message: {
    "contactMessage":{"displayName":'Ochoaxd',"vcard":"BEGIN:VCARD\nVERSION:3.0\nN:2;Ochoa;;;\nFN:Creador\nitem1.TEL;waid=573146224366:+57 314 622 4366\nitem1.X-ABLabel:Mobile\nEND:VCARD"
 }}}
  ...
  client.on("group-participants-update", async (anu) => {
    try {
      ...
      if (anu.action == "add" && mem.includes(client.user.jid)) {
        client.sendMessage(anu.jid, "Hola putas ya llego el mejor bot de whatsapp, me dan unas mamadas¿?", "conversation");
      }
...
if (anu.action == 'add' && !mem.includes(client.user.jid)) {
      ...
      if (anu.action == "promote") {
        ...
        teks = `${anu_user} Eres admin! Felicidades ahora dame unos sentones`;
      ...
      if (anu.action == "demote") {
        ...
        teks = `${anu_user} Ya no eres admin! Ya no te dare mi pito`;
        client.sendMessage(mdata.id, buffer, MessageType.image, {
          caption: teks,
        });
      }
